 ...
 *
 */
public class PayrollCQERangeContainer2 implements RangeContainer
{
	private final static Logger log = Logger.getLogger(PayrollCQERangeContainer2.class);
	private final IndexedCollection<PayrollResult> payrollResultColl;

	public PayrollCQERangeContainer2(long[] data) throws ThresholdExceededException
	{
...
//		final Queue<Short> ids = new ConcurrentLinkedQueue<>();
		...
		if(!payrollResultColl.isEmpty()) {
			...
			idIterator = new PayrollResultIterator(result);
		} else {
